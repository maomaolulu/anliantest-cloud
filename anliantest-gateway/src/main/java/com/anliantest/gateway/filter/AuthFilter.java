package com.anliantest.gateway.filter;
...
import com.anliantest.common.core.constant.TokenConstants;
...
import com.anliantest.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered
{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain)
    {
        ...
        String nickname = JwtUtils.getUserNameCn(claims);
        ...
        addHeader(mutate, SecurityConstants.CN_USERNAME, nickname);
        // 内部请求来源参数清除
